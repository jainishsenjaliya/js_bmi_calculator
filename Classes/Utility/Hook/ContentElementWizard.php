...
class ContentElementWizard {
	 ...
	 * @var string
	 */
	protected $locallangPath = 'LLL:EXT:js_bmi_calculator/Resources/Private/Language/locallang-wizard.xlf:';
	...
	function proc( $wizardItems ) {
		...
		$wizardItems['plugins_tx_jsbmicalculator_bmi'] = array(
			'icon' => ExtensionManagementUtility::extRelPath('js_bmi_calculator') . 'Resources/Public/Icons/wizard_icon.png',
			...
			'params' => '&defVals[tt_content][CType]=list&defVals[tt_content][list_type]=jsbmicalculator_bmi',
