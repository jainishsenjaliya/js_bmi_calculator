<?php
namespace JS\JsBmiCalculator\Utility\Hook;
...
/**
 * Show Plugin Information in Page Module to every js_bmi_calculator content element
 *
 * @package JS\JsBmiCalculator\Utility\Hook
...
class PluginInformation {
	 ...
	 * @var string
	 */
	protected $locallangPath = 'LLL:EXT:js_bmi_calculator/Resources/Private/Language/locallang-plugin-information.xlf:';
	...
	public function build($params = array()) {
		...
		$imagePath = $this->getSubFolderOfCurrentUrl().'typo3conf/ext/js_bmi_calculator/Resources/Public/Icons/plugin-information.png';
	...
	protected function getLabelsAndValues($params) {
		...
		$array = array(
			$this->getLocalizedLabel('underWeight') => $this->getFieldFromFlexform($params,'generalSetting', 'flexform.underweight'),
			$this->getLocalizedLabel('normalWeight') => $this->getFieldFromFlexform($params,'generalSetting', 'flexform.normalweight'),
			$this->getLocalizedLabel('overWeight') => $this->getFieldFromFlexform($params,'generalSetting', 'flexform.overweight'),
			$this->getLocalizedLabel('obesity') => $this->getFieldFromFlexform($params,'generalSetting', 'flexform.obesity'),
		);
	...
	protected function buildImageMarkup($resourcePathAndFilename, $alt = '0') {
		$imagePathAndFilename = $this->getSubFolderOfCurrentUrl().'typo3conf/ext/js_bmi_calculator/Resources/Public/Images/';
